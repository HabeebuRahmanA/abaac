                    ...
                    <tbody>
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('admin/users/edit/' . $user->UserID) ?>" class="btn btn-primary btn-sm">Edit</a>
                                    
                                    <a href="<?= site_url('admin/users/delete/' . $user->UserID) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
